...
namespace QuanLyThuVien.Forms
{
    public partial class FrmDanhMuc : Form
    {
        ...
        {
            if (XacNhanXoa()) ShowResult(service.Xoa("NhanVien", "MaNhanVien", txtNVMa.Text.Trim()));
        }
        ...
        {
            if (XacNhanXoa()) ShowResult(service.Xoa("TheLoai", "MaTheLoai", txtTLMa.Text.Trim()));
        }
        ...
        {
            if (XacNhanXoa()) ShowResult(service.Xoa("NhaXuatBan", "MaNhaXuatBan", txtNXBMa.Text.Trim()));
        }
        ...
        {
            return MessageBox.Show("Xóa dữ liệu đang chọn?", "Xác nhận", MessageBoxButtons.YesNo,
