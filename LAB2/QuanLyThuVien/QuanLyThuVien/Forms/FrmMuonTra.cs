...
namespace QuanLyThuVien.Forms
{
    public partial class FrmMuonTra : Form
    {
        ...
        private void btnTraSach_Click(object sender, EventArgs e)
        {
            ...
            { MessageBox.Show("Vui lòng chọn sách cần trả."); return; }

            DataRowView r = dgvDangMuon.CurrentRow.DataBoundItem as DataRowView;
            if (r == null) return;
            string maCT = Convert.ToString(r["MaChiTiet"]);

            KetQuaXuLy kq = service.TraSach(maCT, MaNhanVienTra, dtNgayTra.Value,
                Convert.ToString(cboTinhTrang.SelectedItem), numPhiPhat.Value);
